                            ...
                            @guest()
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" class="form-control
                                        @error('name') is-invalid @enderror" placeholder="John Doe" aria-label="Name"
                                           wire:model="name">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="email" class="form-control
                                        @error('email') is-invalid @enderror" placeholder="example@mail.com"
                                           aria-label="Email" wire:model="email">
                                    @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <div class="cart-summary p-3 sidebar">
                        ...
                        <div class="d-flex justify-content-between pt-3 border-top">
                            <h3>Total</h3>
                            <h3>${{ \App\Helpers\Cart\Cart::getCartTotalSum() }}</h3>
                        </div>
