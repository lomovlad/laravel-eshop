        ...
        <div class="row">
                            ...
                            <table class="table align-middle table-hover">
                                ...
                                <tr>
                                    <td colspan="6" class="text-end">
                                        <button class="btn btn-outline-danger" wire:click="clearCart" wire:loading.attr="disabled" wire:target="clearCart">
                                            Clear Cart
                                        </button>
                                    </td>
                                </tr>
            ...
            <div class="col-lg-4 mb-3">
                ...
                <div class="cart-summary p-3 sidebar">
                    ...
                    <div class="d-flex justify-content-between my-3">
                        <h3>Total</h3>
                        <h3>{{ \Illuminate\Support\Number::currency(\App\Helpers\Cart\Cart::getCartTotalSum(), in: 'USD') }}</h3>
                    </div>
